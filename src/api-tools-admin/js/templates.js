...
angular.module("html/dashboard-sidebar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/dashboard-sidebar.html",
    "<img src=\"img/ag-hero.png\" alt=\"ApiTools\" class=\"scale\">\n" +
    "\n" +
    "");
}]);
...
angular.module("html/index.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/index.html",
    ...
    "                    <a href=\"https://api-tools.getlaminas.org/documentation\">Read the documentation</a>\n" +
    "                    or <a href=\"https://api-tools.getlaminas.org/video\">watch the screencast</a>\n" +
    "                </p>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "\n" +
...
angular.module("html/modals/cache-check.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/modals/cache-check.html",
    ...
    "\n" +
    "    <p>\n" +
    "        We have detected that your Laminas API Tools Admin API is running with a\n" +
    ...
    "\n" +
    "            <tr>\n" +
    "                <td>Laminas Optimizer+</td>\n" +
    "                <td><kbd>laminas_optimizerplus.enable</kbd></td>\n" +
    "                <td><kbd>\"0\"</kbd></td>\n" +
    "            </tr>\n" +
    "        </tbody>\n" +
    "    </table>\n" +
...
angular.module("html/modals/fs-perms.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/modals/fs-perms.html",
    ...
    "\n" +
    "    <p>\n" +
    "        We have detected that your Laminas API Tools Admin API is running\n" +
    ...
    "\n" +
    "    <p>\n" +
    "        As such, the Laminas API Tools Admin API will not be able to do its\n" +
...
angular.module("html/modals/help-content-negotiation.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/modals/help-content-negotiation.html",
    ...
    "\n" +
    "    <p>\n" +
    "        Each selector consists of maps of Laminas <a href=\"https://getlaminas.org/manual/2.2/en/modules/laminas.view.quick-start.html#controllers-and-view-models\">View\n" +
    ...
    "        <kbd>Laminas\\ApiTools\\ContentNegotiation\\ViewModel</kbd>.\n" +
    "    </p>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"modal-footer\">\n" +
    "    <p class=\"pull-left\">\n" +
    "        <a href=\"https://api-tools.getlaminas.org/documentation/api-primer/content-negotiation\" target=\"_blank\">\n" +
    "            <i class=\"glyphicon glyphicon-info-sign\"></i>\n" +
    "            More information\n" +
    "        </a>\n" +
    "    </p>\n" +
...
angular.module("html/modals/help-input-filter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/modals/help-input-filter.html",
    ...
    "        href=\"https://getlaminas.org/manual/2.2/en/modules/laminas.validator.set.html\">the\n" +
    "Laminas reference guide on validators</a>. \n" +
    "    </p>\n" +
    "\n" +
    "    <p>\n" +
    "        For more information on available filters and their\n" +
    "        options, please see <a\n" +
    "        href=\"https://getlaminas.org/manual/2.2/en/modules/laminas.filter.set.html\">the\n" +
    "Laminas reference guide on filters</a>. \n" +
    "    </p>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"modal-footer\">\n" +
    "    <p class=\"pull-left\">\n" +
    "        <a href=\"https://api-tools.getlaminas.org/documentation/content-validation/basic-usage\" target=\"_blank\">\n" +
    "            <i class=\"glyphicon glyphicon-info-sign\"></i>\n" +
    "            More information\n" +
    "        </a>\n" +
    "    </p>\n" +
...
angular.module("html/settings/authentication/index.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/settings/authentication/index.html",
    ...
    "    </div>\n" +
    "\n" +
    "    <p><a href=\"https://api-tools.getlaminas.org/documentation/auth/authentication-about\" target=\"_blank\">\n" +
...
angular.module("html/settings/dashboard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("html/settings/dashboard.html",
    ...
    "        </p>\n" +
    "\n" +
    "        <p><a href=\"https://api-tools.getlaminas.org/documentation/api-primer/content-negotiation\" target=\"_blank\">\n" +
    "            <i class=\"glyphicon glyphicon-info-sign\"></i> More information\n" +
    "        </a></p>    \n" +
    "    </div>\n" +
    "\n" +
