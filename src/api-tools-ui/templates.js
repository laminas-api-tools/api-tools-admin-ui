...
angular.module("api-tools-ui/about/about.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/about/about.html",
    ...
    "      </div>\n" +
    "      <p><strong>Laminas API Tools</strong> is the open source API builder for PHP, designed to simplify creating and maintaining useful, easy to consume, and well structured APIs. Regardless of your experience in API building, with <strong>Laminas API Tools</strong> you can build APIs that enable mobile apps, developer communities, and any other consumer controlled access to your applications.</p>\n" +
    ...
    "      <p><strong>Laminas API Tools</strong> is made using <a href=\"https://getlaminas.org\" target=\"_blank\">Laminas</a>, <a href=\"https://angularjs.org/\" target=\"_blank\">AngularJS</a> and <a href=\"http://getbootstrap.com/\" target=\"_blank\">Bootstrap</a>.</p>\n" +
    "      <p>If you want to contribute you can <a href=\"https://github.com/laminascampus\" target=\"_blank\">fork the project on github</a>.</p>\n" +
    "      <p>The official web site of the project is <a href=\"https://api-tools.getlaminas.org\" target=\"_blank\">api-tools.getlaminas.org</a>.</p>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("api-tools-ui/modal/edit-field.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-field.html",
    ...
    "  <input type=\"checkbox\" ng-model=\"vm.field.type\" value=\"Laminas\\InputFilter\\FileInput\" class=\"col-sm-2 control-label\">\n" +
